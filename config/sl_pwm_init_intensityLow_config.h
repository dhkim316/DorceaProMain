...
#define SL_PWM_INTENSITYLOW_PERIPHERAL              TIMER1
#define SL_PWM_INTENSITYLOW_PERIPHERAL_NO           1

#define SL_PWM_INTENSITYLOW_OUTPUT_CHANNEL          0
#define SL_PWM_INTENSITYLOW_OUTPUT_PORT             gpioPortB
#define SL_PWM_INTENSITYLOW_OUTPUT_PIN              2
// [TIMER_SL_PWM_INTENSITYLOW]$
